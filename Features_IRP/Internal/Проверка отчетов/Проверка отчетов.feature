...
Сценарий: _0902 проверка отчета Информация по номенклатуре
	...
	Дано Табличный документ "Result" равен макету "информация по товарам 1 макет" по шаблону
...
Сценарий: _0903 проверка отчета по Закупкам
	...
	//И я жду, что в табличном документе "Result" ячейка "R1C1" станет равна "ЗначениеЯчейки" в течение 20 секунд
